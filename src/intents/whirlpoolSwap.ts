...
export function isWhirlpoolSwapIntent(
  intent: Intent
): intent is Intent & { type: "whirlpool_swap" } {
...
export async function buildWhirlpoolSwapInstructions(
  connection: Connection,
  authorityKeypair: Keypair,
  intent: Extract<Intent, { type: "whirlpool_swap" }>
